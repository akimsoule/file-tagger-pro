...
export default class TreeNode {
  ...
  public clone(newId?: string, newParentId?: string): TreeNode {
    ...
    const stack: { original: TreeNode; cloned: TreeNode }[] = [{ original: this, cloned }];
  ...
  public toJSON(): TreeNodeJSON {
    ...
    const stack: { node: TreeNode; jsonNode: TreeNodeJSON }[] = [{ node: this, jsonNode: result }];
  ...
  public static fromJSON(json: TreeNodeJSON): TreeNode {
    const node = new TreeNode(json.id, json.name, json.type, json.tags, json.stats, json.parentId);
