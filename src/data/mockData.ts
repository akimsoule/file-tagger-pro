...
export const mockDocuments: Document[] = [
  ...
  createDocument(
    "doc-2",
    "Project Shortcut.webloc",
    "application/octet-stream",
    1_024,
    "Shortcut to project site",
    "desktop,system",
    "f-desktop",
  ),
  ...
  createDocument(
    "doc-3",
    "Quarterly Report Q2.xlsx",
    "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
    512_000,
    "Financial report for Q2",
    "work,finance,documents",
    "f-work",
    true,
  ),
  createDocument(
  ...
  createDocument(
    "doc-11",
    "Screenshot 2025-09-01 at 10.32.11.png",
    "image/png",
    1_572_864,
    "Desktop screenshot",
    "pictures,screenshots",
  ...
  createDocument(
    "doc-13",
    "Setup-Tool-1.2.3.dmg",
    "application/x-apple-diskimage",
    85_000_000,
    "macOS installer",
    "downloads,installers,mac",
    "f-installers",
  ),
  createDocument(
    "doc-14",
    "VSCodeUserSetup-x64-1.92.0.exe",
