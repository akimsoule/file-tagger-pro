    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-50 via-white to-indigo-50 p-4">
      <div className="w-full max-w-md relative">
        ...
        <div className="relative rounded-xl bg-white/90 backdrop-blur shadow-xl border border-indigo-100/60 p-8">
          ...
          <h1 className="text-center text-2xl font-semibold bg-gradient-to-br from-indigo-600 to-violet-600 bg-clip-text text-transparent">
            FileTaggerPro
          </h1>
          ...
          <div className="mt-6 mb-2 flex rounded-md overflow-hidden border border-slate-200 text-sm font-medium">
            <button
              ...
              className={`flex-1 px-4 py-2 flex items-center justify-center gap-1 transition ${mode === "login" ? "bg-white text-indigo-600 shadow inset-shadow border-r border-slate-200" : "bg-slate-50 hover:bg-slate-100 text-slate-500 border-r border-slate-200"}`}
            >
              ↪ Connexion
            </button>
            <button
              ...
              className={`flex-1 px-4 py-2 flex items-center justify-center gap-1 transition ${mode === "register" ? "bg-white text-indigo-600 shadow inset-shadow" : "bg-slate-50 hover:bg-slate-100 text-slate-500"}`}
            >
              👤 Inscription
            </button>
          </div>
          ...
          <form onSubmit={submit} className="space-y-5 mt-4">
            {session.error && (
              <div
                className="rounded-md bg-red-50 px-3 py-2 text-xs text-red-600 border border-red-200 cursor-pointer"
                onClick={clearError}
              >
                {session.error}
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                {mode === "login" && (
                  <button
                    ...
                    onClick={() => alert("Flow à implémenter")}
                  >
                    Mot de passe oublié ?
                  </button>
                )}
            ...
            <button
              ...
              className="group relative w-full overflow-hidden rounded-md bg-gradient-to-r from-indigo-600 to-violet-600 py-2.5 text-sm font-medium text-white shadow hover:from-indigo-500 hover:to-violet-500 disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-indigo-300"
            >
            ...
            <div className="text-center text-[10px] text-slate-400">
              © {new Date().getFullYear()} FileTaggerPro
            </div>
            <div className="text-center text-[10px] text-slate-400">
